# How to contribute
Contributions to Invoke-Tearraform are highly encouraged and desired. Below are some guidelines that will help make the process as smooth as possible.
...
We want to know what you think is missing from Invoke-Tearraform and how it can be made better.
...
* To quickly create a topic branch based on master; `git checkout -b my_contribution main`. Please avoid working directly on the `main` branch.
